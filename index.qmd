...
*Optimal locations for bikeshare stations: A new GIS based spatial approach*\[\^2\]:

*Using a GIS-based spatial approach to determine the optimal locations of bikeshare stations: The case of Washington D.C*\[\^3\]:
